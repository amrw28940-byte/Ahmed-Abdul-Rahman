        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-sm text-slate-300">
              <li>
                <Link href="/" title="الذهاب إلى الصفحة الرئيسية" className="hover:text-[#5bc0de] transition-colors flex items-center gap-2">
                  <span className="text-[#5bc0de]">■</span> الرئيسية
                </Link>
              </li>
              <li>
                <Link href="/services" title="استعرض خدماتنا الطبية والتجميلية" className="hover:text-[#5bc0de] transition-colors flex items-center gap-2">
                  <span className="text-[#5bc0de]">■</span> خدماتنا الطبية
                </Link>
              </li>
              <li>
                <Link href="/about" title="تعرف أكثر على مسيرة دكتور أحمد عبد الرحمن" className="hover:text-[#5bc0de] transition-colors flex items-center gap-2">
